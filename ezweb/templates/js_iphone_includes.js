...
<script language="JavaScript" src="{{ MEDIA_URL }}iphone/lib/mymw/mymw-core.js"></script>
<script language="JavaScript" src="{{ MEDIA_URL }}iphone/lib/mymw/mymw-tabs.js"></script>

<script type="text/javascript" language="javascript" src="{{ MEDIA_URL }}js/common/constants.js"></script>
<script type="text/javascript" language="javascript" src="{{ MEDIA_URL }}iphone/common/utils.js"></script>
...
<script language="JavaScript" src="{{ MEDIA_URL }}iphone/catalogue/Catalogue.js"></script>
...
<script language="JavaScript" src="{{ MEDIA_URL }}iphone/gadgetModel/Gadget.js"></script>


<script language="JavaScript" src="{{ MEDIA_URL }}iphone/opManager/WorkSpace.js"></script>
<script language="JavaScript" src="{{ MEDIA_URL }}iphone/opManager/Tab.js"></script>

<script language="JavaScript" src="{{ MEDIA_URL }}iphone/opManager/OpManager.js"></script>
...
<script language="JavaScript" src="{{ MEDIA_URL }}iphone/showcase/showcase.js"></script>
...
<script language="JavaScript" src="{{ MEDIA_URL }}iphone/add-ons/wiring.js"></script>
<script language="JavaScript" src="{{ MEDIA_URL }}iphone/add-ons/connectable.js"></script>