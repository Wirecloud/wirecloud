...
subscriptions by using the [updateSubscription](https://conwet.fi.upm.es/docs/display/wirecloud/NGSI+Javascript+API#NGSIJavascriptAPI-NGSIConnectionupdateSubscription) method, even if they have
