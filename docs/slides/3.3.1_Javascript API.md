...
[documentation about context managers](#slide44) for more information.
...
[documentation about context managers](#slide51) for more information.
...
- `level` (optional, default: `MashupPlatform.log.ERROR`): This optional parameter specifies the level to use for logging the message. (See [MashupPlatform.log](#slide17) for available log levels.
...
- `msg` (String): is the text of the message to log.
- `level` (optional, default: `MashupPlatform.log.ERROR`): This optional parameter specifies the level to use for logging the message. (See [MashupPlatform.log](#slide20) for available log levels.
...
- [`hasInputConnections`](#slide43)
- [`hasOutputConnections`](#slide44)
- [`pushEvent`](#slide45)
- [`registerCallback`](#slide46)

and three exceptions:

- [`EndpointDoesNotExistError`](#slide47)
- [`EndpointTypeError`](#slide48)
- [`EndpointValueError`](#slide49)
...
* [`getAvailableContext`](#slide52)
* [`get`](#slide53)
* [`registerCallback`](#slide54)
