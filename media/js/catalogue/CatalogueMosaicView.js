...
function CatalogueMosaicView() {
		...
		this.mainCatalogueElement = $('catalogue');
		this.catalogueElement = $('showcase_container');
		this.headElement = $('head');
		this.resourceHeaderElement = $("resources_header");
		this.resourcesElement = $('resources');
		this.resourcesContainerElement = $('resources_container');
		this.centerElement = $('center');
	    this.leftBarElement = $('left_bar');
