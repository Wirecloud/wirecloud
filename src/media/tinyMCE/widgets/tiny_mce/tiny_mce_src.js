...
TinyMCE_Engine.prototype = {
    ...
    loadScriptIntoFrame : function(doc, url) {
	...
	setupContent : function(editor_id) {
        ...
        for (i= 0; i< inst.settings['url_js'].length; i++)
        {
            tinyMCE.loadScriptIntoFrame(inst.getBody().parentNode.parentNode,inst.settings['url_js'][i]);
        }
...
TinyMCE_Control.prototype = {
	...
	_onAdd : function(replace_element, form_element_name, target_document) {
        ...
        {
            text_area = document.getElementById(form_element_name);
            this.settings['height']=text_area.parentNode.parentNode.offsetHeight;
        }
