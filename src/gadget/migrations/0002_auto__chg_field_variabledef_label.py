...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('gadget_variabledef', 'label', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'VariableDef.label'
        db.alter_column('gadget_variabledef', 'label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
