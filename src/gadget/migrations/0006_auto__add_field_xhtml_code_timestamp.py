...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gadget_xhtml', 'code_timestamp', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'XHTML.code_timestamp'
        db.delete_column('gadget_xhtml', 'code_timestamp')
