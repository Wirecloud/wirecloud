...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('workspace', '0010_remove_shared_variables'),
    )
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VariableDef.shared_var_def'
        db.delete_column('gadget_variabledef', 'shared_var_def_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'VariableDef.shared_var_def'
        db.add_column('gadget_variabledef', 'shared_var_def', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gadget.SharedVariableDef'], null=True, blank=True), keep_default=False)
