...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # A/srcdding field 'VariableDef.secure'
        db.add_column('gadget_variabledef', 'secure', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'VariableDef.secure'
        db.delete_column('gadget_variabledef', 'secure')
