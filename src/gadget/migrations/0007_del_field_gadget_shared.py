...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Gadget.shared'
        db.delete_column('gadget_gadget', 'shared')

    def backwards(self, orm):

        # Adding field 'Gadget.shared'
        db.add_column('gadget_gadget', 'shared', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)
