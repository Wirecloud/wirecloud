...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('twitterauth_twitteruserprofile', (
        ...
        db.send_create_signal('twitterauth', ['TwitterUserProfile'])


    def backwards(self, orm):

        # Deleting model 'TwitterUserProfile'
        db.delete_table('twitterauth_twitteruserprofile')
    ...
    models = {
        ...
        'twitterauth.twitteruserprofile': {
