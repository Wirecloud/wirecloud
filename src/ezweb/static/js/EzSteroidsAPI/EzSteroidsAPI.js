...
function EzSteroidsAPIClass(policies) {
    if (policies) {
...
EzSteroidsAPIClass.prototype.is_activated = function () {
    return this.userPolicies && this.globalPolicies;
};

EzSteroidsAPIClass.prototype.evaluePolicy = function (policy) {
    var i, p;
    ...
    for (i = 0; i < this.userPolicies.length; i += 1) {
    ...
    for (i = 0; i < this.globalPolicies.length; i += 1) {
...
var EzSteroidsAPI = new EzSteroidsAPIClass(policy_lists);