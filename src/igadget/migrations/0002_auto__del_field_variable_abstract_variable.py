...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Variable.abstract_variable'
        db.delete_column('igadget_variable', 'abstract_variable_id')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Variable.abstract_variable'
        raise RuntimeError("Cannot reverse this migration. 'Variable.abstract_variable' and its values cannot be restored.")
