...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'VariableDef.action_label'
        db.alter_column('wirecloud_variabledef', 'action_label', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'VariableDef.label'
        db.alter_column('wirecloud_variabledef', 'label', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'VariableDef.friend_code'
        db.alter_column('wirecloud_variabledef', 'friend_code', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'VariableDef.description'
        db.alter_column('wirecloud_variabledef', 'description', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
