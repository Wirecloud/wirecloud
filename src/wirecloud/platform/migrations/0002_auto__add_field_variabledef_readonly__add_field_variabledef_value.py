...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VariableDef.readonly'
        db.add_column('wirecloud_variabledef', 'readonly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VariableDef.value'
        db.add_column('wirecloud_variabledef', 'value',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VariableDef.readonly'
        db.delete_column('wirecloud_variabledef', 'readonly')

        # Deleting field 'VariableDef.value'
        db.delete_column('wirecloud_variabledef', 'value')
    ...
    models = {
        ...
        u'catalogue.catalogueresource': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 28, 0, 0)'}),
