...
(function (ns, se, utils) {
    ...
    ns.CatalogueSearchView = class CatalogueSearchView extends se.Alternative {
        ...
        _search(page, options, onSuccess, onError) {
            options = {
    ...
    ns.CatalogueSearchView.prototype.view_name = "search";
