...
(function () {
     ...
     *
     */
    var PlatformPreferencesDef = function PlatformPreferencesDef(definitions) {
        Wirecloud.PreferencesDef.call(this, definitions);
    };
    PlatformPreferencesDef.prototype = new Wirecloud.PreferencesDef();

    PlatformPreferencesDef.prototype.buildPreferences = function buildPreferences(values) {
        return new Wirecloud.PlatformPreferences(this, values);
    };

    Wirecloud.PlatformPreferencesDef = PlatformPreferencesDef;
