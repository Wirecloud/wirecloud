...
(function (ns, se, utils) {
    ...
    /**
     * Specific class for packaging workspaces
     */
    ns.PublishWorkspaceWindowMenu = class PublishWorkspaceWindowMenu extends ns.FormWindowMenu {
        ...
        constructor(workspace) {
            ...
            super(fields, utils.gettext('Upload workspace to my resources'), 'wc-upload-workspace-modal', {autoHide: false});
        ...
        _addVariableParametrization(workspace, fields) {
            var tab_field;
