...
(function (ns, se, utils) {
    ...
    ns.ParametrizedTextInputInterface = class ParametrizedTextInputInterface extends se.InputInterface {
        ...
        constructor(fieldId, options) {
            ...
            this.wrapperElement = new se.Container({
                'class': 'parametrized_text_input'
            });

            this.resetButton = new se.Button({
                'text': utils.gettext('Use current value')
            });
            ...
            this.selectorWrapperElement = new se.Container({
            ...
            this.addButton = new se.Button({
                'text': utils.gettext('Add')
            });
        ...
        getAvailableParameters() {
            ...
            if (ParametrizedTextInputInterface.prototype._CONTEXT_PARAMS === null) {
                ...
                parameters = [
                    {
                        label: utils.gettext('User'),
                        value: 'user',
                        fields: [
                            {
                                label: utils.gettext('User Name'),
                                description: '',
                                value: 'username'
                            },
                            {
                                label: utils.gettext('First Name'),
                                description: '',
                                value: 'first_name'
                            },
                            {
                                label: utils.gettext('Last Name'),
                                description: '',
                                value: 'last_name'
                            }
                        ]
    ...
    ns.ParametrizedTextInputInterface.prototype._CONTEXT_PARAMS = null;
    ns.ParametrizedTextInputInterface.prototype._ESCAPE_RE = new RegExp("(%+)(\\([a-zA-Z]\\w*(?:\\.[a-zA-Z]\\w*)*\\))");
    ns.ParametrizedTextInputInterface.prototype._ESCAPE_FUNC = function () {
        var str, i;
