...
(function (utils) {
    ...
    Wirecloud.TutorialCatalogue.add('basic-concepts', new Wirecloud.ui.Tutorial(utils.gettext('Basic concepts'), [
            ...
            {'type': 'userAction', 'msg': utils.gettext("Drag &amp; drop to move the widget"), 'elem': widget_title.bind(null, 1), 'pos': 'downRight', 'event': 'mouseup', 'eventToDeactivateLayer': 'mousedown', 'elemToApplyNextStepEvent': getDocument},
            {'type': 'userAction', 'msg': utils.gettext("Open <em>Input Box</em> menu"), 'elem': widget_menu.bind(null, 1), 'pos': 'downRight', 'event': 'mouseup', 'eventToDeactivateLayer': 'mousedown', 'elemToApplyNextStepEvent': getDocument},
