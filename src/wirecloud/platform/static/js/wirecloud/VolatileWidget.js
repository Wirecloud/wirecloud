...
(function () {
    ...
    VolatileWidget.prototype = new StyledElements.ObjectWithEvents();

    VolatileWidget.prototype.isAllowed = function isAllowed(action) {
    ...
    VolatileWidget.prototype.registerPrefCallback = function registerPrefCallback(prefCallback) {
        this.prefCallback = prefCallback;
    };

    VolatileWidget.prototype.registerContextAPICallback = function registerContextAPICallback(scope, callback) {
        switch (scope) {
        case 'iwidget':
     ...
     * @private
     */
    VolatileWidget.prototype._notifyLoaded = function _notifyLoaded(element) {
    ...
    VolatileWidget.prototype._notifyUnloaded = function _notifyUnloaded() {
        var i;
    ...
    VolatileWidget.prototype.buildInterface = function buildInterface(template, view) {
        return new Wirecloud.ui.IWidgetView(this, template, view);
    };

    VolatileWidget.prototype.fullDisconnect = function fullDisconnect() {
