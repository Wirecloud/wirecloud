...
(function () {
    ...
    var TabPreferencesDef = function TabPreferencesDef(definitions) {
        Wirecloud.PreferencesDef.call(this, definitions);
    };
    TabPreferencesDef.prototype = new Wirecloud.PreferencesDef();

    TabPreferencesDef.prototype.buildPreferences = function buildPreferences(values, tab) {
        return new Wirecloud.TabPreferences(this, tab, values);
    };

    Wirecloud.TabPreferencesDef = TabPreferencesDef;
