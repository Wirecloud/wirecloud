...
def get_iwidget_data(iwidget, workspace, cache_manager=None, user=None):
    ...
    data_ret = {
        ...
        'relx': widget_position.get('relx', True),
        'rely': widget_position.get('rely', False),
        'relheight': widget_position.get('relheight', False),
        'relwidth': widget_position.get('relwidth', True),
