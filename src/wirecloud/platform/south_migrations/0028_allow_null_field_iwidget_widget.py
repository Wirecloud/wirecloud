...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IWidget.widget'
        db.alter_column('wirecloud_iwidget', 'widget_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['platform.Widget'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'IWidget.widget'
        raise RuntimeError("Cannot reverse this migration. 'IWidget.widget' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'IWidget.widget'
        db.alter_column('wirecloud_iwidget', 'widget_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['platform.Widget']))
    ...
    models = {
        ...
        u'platform.workspace': {
            ...
            'creation_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1444387410602.04'}),
