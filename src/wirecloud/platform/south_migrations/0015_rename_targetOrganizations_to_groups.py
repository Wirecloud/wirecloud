...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename M2M table for field targetOrganizations (new name: groups) on 'Workspace'
        db.rename_table(db.shorten_name(u'wirecloud_workspace_targetOrganizations'), db.shorten_name('wirecloud_workspace_groups'))

    def backwards(self, orm):
        # Rename M2M table for field groups (old name: targetOrganizations) on 'Workspace'
        db.rename_table(db.shorten_name('wirecloud_workspace_groups'), db.shorten_name(u'wirecloud_workspace_targetOrganizations'))
    ...
    models = {
        ...
        u'platform.workspace': {
            ...
            'creation_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1413903330848.165'}),
