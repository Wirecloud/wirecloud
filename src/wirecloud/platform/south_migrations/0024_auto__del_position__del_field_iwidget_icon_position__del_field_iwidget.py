...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'IWidget.icon_position'
        db.delete_column('wirecloud_iwidget', 'icon_position_id')

        # Deleting field 'IWidget.position'
        db.delete_column('wirecloud_iwidget', 'position_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'IWidget.icon_position'
        db.add_column('wirecloud_iwidget', 'icon_position',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='Icon_Position', null=True, to=orm['platform.Position'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'platform.workspace': {
            ...
            'creation_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1436865414904.1892'}),
