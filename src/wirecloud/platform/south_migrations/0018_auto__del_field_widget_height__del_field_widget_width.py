...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('wirecloud_widget', 'height')

        # Deleting field 'Widget.width'
        db.delete_column('wirecloud_widget', 'width')

    def backwards(self, orm):
        # Adding field 'Widget.height'
        db.add_column('wirecloud_widget', 'height',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Widget.width'
        db.add_column('wirecloud_widget', 'width',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
    ...
    models = {
        ...
        'platform.variable': {
            ...
            'vardef': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['platform.VariableDef']"})
        },
        u'platform.variabledef': {
            'Meta': {'object_name': 'VariableDef', 'db_table': "u'wirecloud_variabledef'"},
        ...
        u'platform.workspace': {
            ...
            'creation_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1434460710022.5688'}),
