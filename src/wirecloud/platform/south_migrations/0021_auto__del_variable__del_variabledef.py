...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'wirecloud_variabledef')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'wirecloud_variabledef', (
        ...
        db.send_create_signal(u'platform', ['VariableDef'])
    ...
    models = {
        ...
        u'platform.workspace': {
            ...
            'creation_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1435673212820.502'}),
