...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IWidget.widget_uri'
        db.add_column('wirecloud_iwidget', 'widget_uri',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)

        if not db.dry_run:
            for iwidget in orm.IWidget.objects.select_related('widget__resource').all():
                resource = iwidget.widget.resource 
                iwidget.widget_uri = resource.vendor + '/' + resource.short_name + '/' + resource.version
                iwidget.save()

    def backwards(self, orm):
        # Deleting field 'IWidget.widget_uri'
        db.delete_column('wirecloud_iwidget', 'widget_uri')
    ...
    models = {
        ...
        u'platform.workspace': {
            ...
            'creation_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1444386842890.502'}),
