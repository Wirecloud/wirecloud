...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('wirecloud_iwidget', 'widget_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['platform.Widget'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        'platform.iwidget': {
            ...
            'widget': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['platform.Widget']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        u'platform.workspace': {
            ...
            'creation_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1454330965479.583'}),
