...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IWidget.variables'
        db.add_column('wirecloud_iwidget', 'variables',
                      self.gf('wirecloud.commons.fields.JSONField')(default='{}', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IWidget.variables'
        db.delete_column('wirecloud_iwidget', 'variables')
    ...
    models = {
        ...
        u'platform.workspace': {
            ...
            'creation_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1435670753642.049'}),
