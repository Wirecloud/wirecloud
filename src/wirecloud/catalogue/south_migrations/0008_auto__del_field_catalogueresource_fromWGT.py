...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CatalogueResource.fromWGT'
        db.delete_column(u'catalogue_catalogueresource', 'fromWGT')

    def backwards(self, orm):
        # Adding field 'CatalogueResource.fromWGT'
        db.add_column(u'catalogue_catalogueresource', 'fromWGT',
