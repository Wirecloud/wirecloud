...
(function () {
    ...
    var _OpenStorageAPI = function _OpenStorageAPI(parent, platform, _) {
        var manager = platform.OpenStackManager;
        ...
        var realGetTenants = function realGetTenants(options) {
            ...
            parent.MashupPlatform.http.makeRequest(url, {
                method: 'GET',
        ...
        var realGetAuthToken = function realGetAuthToken(postBody, headers, options) {
            parent.MashupPlatform.http.makeRequest(this.url + this.v2.TOKENS_ENDPOINT, {
                requestHeaders: headers,
    ...
    if (window.parent !== window) {
        _OpenStorageAPI(window, window.parent);
    } else {
        Wirecloud.APIRequirements.OpenStorage = _OpenStorageAPI;
    }
