...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('workspace_variablevalue', 'variable', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['igadget.Variable']))

        #for orm.VariableValue.objects.all():
