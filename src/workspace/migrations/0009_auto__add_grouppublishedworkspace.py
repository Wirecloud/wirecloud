...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('workspace_grouppublishedworkspace', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('workspace', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workspace.PublishedWorkSpace'])),
        ))
        db.send_create_signal('workspace', ['GroupPublishedWorkspace'])

    def backwards(self, orm):

        # Deleting model 'GroupPublishedWorkspace'
        db.delete_table('workspace_grouppublishedworkspace')
