...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WorkSpace.branding'
        db.delete_column('workspace_workspace', 'branding_id')

    def backwards(self, orm):

        # Adding field 'WorkSpace.branding'
        db.add_column('workspace_workspace', 'branding', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['layout.Branding'], null=True, blank=True), keep_default=False)
