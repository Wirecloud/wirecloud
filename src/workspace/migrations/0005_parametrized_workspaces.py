...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for published_workspace in orm.PublishedWorkSpace.objects.all():
            published_workspace.creator = published_workspace.workspace.creator
            published_workspace.template = build_template_from_workspace(published_workspace.workspace)
