...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserWorkSpace.manager'
        db.add_column('workspace_userworkspace', 'manager', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'UserWorkSpace.reason_ref'
        db.add_column('workspace_userworkspace', 'reason_ref', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'UserWorkSpace.manager'
        db.delete_column('workspace_userworkspace', 'manager')

        # Deleting field 'UserWorkSpace.reason_ref'
        db.delete_column('workspace_userworkspace', 'reason_ref')
