...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PublishedWorkSpace.contratable'
        db.delete_column('workspace_publishedworkspace', 'contratable')

    def backwards(self, orm):

        # Adding field 'PublishedWorkSpace.contratable'
        db.add_column('workspace_publishedworkspace', 'contratable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
