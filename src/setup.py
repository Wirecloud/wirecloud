...
setup(
    ...
    install_requires=('Django>=1.4.2,<1.7', 'south>=0.7.4,<2.0', 'lxml', 'BeautifulSoup', 'django_compressor>=1.2', 'rdflib>=3.2.0', 'requests>=2.0.0', 'selenium', 'pytz', 'django_relatives', 'user-agents'),
