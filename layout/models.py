...
class SkinTemplate(models.Model):
    ...
    def __unicode__(self):
        return unicode(self.layout) + "-" + unicode(self.type)
...
class Skin(models.Model):
    ...
    def __unicode__(self):
        return "'" + unicode(self.name) + "' skin for '" + unicode(self.layout) + "' layout"
...
class ThemeBranding(models.Model):
    ...
    def __unicode__(self):
        return "Branding '"+ unicode(self.branding) +"' for '" + unicode(self.theme) + "' theme. Type: " + unicode(self.type)
