...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InOut.filter_param_values'
        db.alter_column('connectable_inout', 'filter_param_values', self.gf('django.db.models.fields.TextField')(default=''))


    def backwards(self, orm):
        
        # Changing field 'InOut.filter_param_values'
        db.alter_column('connectable_inout', 'filter_param_values', self.gf('django.db.models.fields.TextField')(null=True))
